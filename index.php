    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
			...
			<li><a href="cmpny_login.php">Company</li>
		</ul>
      </div>
      <div class="logo">
        ...
        <div class="article">
			<!-- <h2>Register Here</h2>
			 <fieldset>
				...
				<p id="Student Registration Form">
				<?php 
				/*include "student_reg_form.php"; */
				?>
            </fieldset>
			
			<fieldset>
				<legend>Company Registration Form</legend>
				<p id="Company Registration Form">
				<?php 
				/*include "company_reg_form.php";*/
				?>
            </fieldset>
			-->
			<b><font size="5">About us</font></b>
			<br>
			<br>
			<br><br>
		<font size="3"><p align="left">Online Campus Recruitment System (Online CRS) is a web based tool and reduces the time and cost.Online recruitment offers great flexibility and ease of access to job searches.<br>Opportunity for the freshly graduates to access the information about the organization.Online CRS is web-based tool to reduce communication gap between Job providers and Job seekers. <br>The Main objective of this solution is to make easy the recruitment process of any organization. This system is designed by keeping in mind both parties Job providers and Job seekers. It allows Job seekers to register their details like skills and experience with the system, and then on the other hand even it allows job providers to post their requirements with the system. </p> 
