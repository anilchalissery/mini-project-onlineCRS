  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
			<?php
				$sql_user="select * from student_academics where job_id =";
				//echo $sql_user;
				$result=$conn->query($sql_user);
				...
				if($count!=0)
				{
					...
					for($i=0;$i<$count;$i++)
					{
						...
						echo "<td>" . $row['YOP'] . "</td>";
						echo "<td>" . $row['Curr_CGPA'] . "</td>";
						echo "<td>" . $row['Backlogs'] . "</td>";
						echo "<td>" . $row['sslcyop'] . "</td>";
						echo "<td>" . $row['sslcperc'] . "</td>";
						echo "<td>" . $row['plustwoyop'] . "</td>";
						echo "<td>" . $row['plustwoperc'] . "</td>";
						echo "<td>" . $row['Dgryop'] . "</td>";
						echo "<td>" . $row['graduperc'] . "</td>";
						echo "<td>" . $row['resume'] . "</td>";
						echo "<td>" . $row['photo'] . "</td>";
						
						//echo "<td><a href=\"sadelete.php?id=".$row['ap_id']."\">Delete</a></td>";
						//echo "<td><a href=\"sadelete.php?id=".$row['ap_id']."\">Delete</a></td>";//wrk
