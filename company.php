...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
			<h2>View Registered Company</h2>
			<?php
				$sql_user="select * from company_reg";
				//echo $sql_user;
				...
				if($count!=0)
				{
					...
					for($i=0;$i<$count;$i++)
					{
						...
						echo "<td>" . $row['site_addr'] . "</td>";
						echo "<td>" . $row['about_us'] . "</td>";
						echo "<td>" . $row['username'] . "</td>";
						echo "<td><a href=\"cdelete.php?id=".$row['cm_id']."\">Delete</a></td>";//wrk
						echo "</tr>";
						echo "</tbody>"; 
					}
				}
			...
			?>
				...
				<br>
				<a href="viewcmpny.php">[View Company Vacancy]</a>
