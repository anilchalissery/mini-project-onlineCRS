...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
         <ul>
          ...
          <!--<li><a href="viewstud.php"><span>View Applied Students</span></a></li>-->
		  <li><a href="student.php"><span>View Students</span></a></li>
		  <li><a href="company.php"><span>View Company</span></a></li>
          <!--<li><a href="viewcmpny.php"><span>View Companys Vacancy</span></a></li>-->
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
			<h2><b>About Admin</b></h2>
			<font size="3"><p>The Administrator can access the data of any student and company and even make changes to it.</p></font>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="viewstud.php">View Applied students</a></li>
            <li><a href="viewcmpny.php">View company vacanies</a></li>
			<li><a href="student.php">View students</a></li>
            <li><a href="company.php">View company </a></li>
