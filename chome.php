  ...
  <div class="header">
    <div class="header_resize">
      <div class="menu_nav">
         ...
         <!--<li><a href="viewappln.php"><span>View applied Students</span></a></li>-->
		...
		<font size="5"><font color="#00008B">Welcome </font><font color="#800080"><?php echo (isset($user_cname))?$user_cname:""?></font></font>
			...
			<form method="post" action="">
				<table border="1">
					...
					<tr> <td>COMPANY NAME:</td><td><?php echo (isset($user_cname))?$user_cname:""?></td> </tr>
					<tr> <td>HR NAME:</td><td><?php echo (isset($user_hrname))?$user_hrname:""?></td> </tr>
					<tr> <td>HR EMAIL ID:</td><td><?php echo (isset($user_hremail))?$user_hremail:""?></td> </tr>
					<tr> <td>CONTACT NO:</td><td><?php echo (isset($user_hrmobile))?$user_hrmobile:""?></td> </tr>
					<tr> <td>SITE ADDRESS:</td><td><?php echo (isset($user_siteaddr))?$user_siteaddr:""?></td> </tr>
					<tr> <td>ABOUT US:</td><td><?php echo (isset($user_aboutus))?$user_aboutus:""?></td> </tr>
